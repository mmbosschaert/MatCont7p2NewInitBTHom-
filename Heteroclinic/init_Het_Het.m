function [x,v] = init_Het_Het(odefile, x, v, s, p, ap, ntst, ncol,extravec,T,eps0,eps1)
...
hetds.ntst = oldhetds.ntst;
hetds.ncol = oldhetds.ncol;
hetds.tps = oldhetds.ntst*oldhetds.ncol+1;
hetds.ncoords = oldhetds.tps*oldhetds.nphase;
hetds.coords = 1:oldhetds.ncoords;
hetds.msh = oldhetds.msh;
