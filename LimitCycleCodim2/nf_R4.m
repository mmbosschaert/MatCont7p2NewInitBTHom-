function result=nf_R4(x)
%
% calculates R4 normal form coefficient
%
global lds
...
jac(range,[lds.phases range1]) = bordBVP_R4_minpi2_bc1;
...
range  = (lds.tps-1)*lds.nphase+ (lds.phases);
range1 = lds.ncoords-lds.nphase+lds.phases;
jac(range,[lds.phases range1]) = bordBVP_R2_bc1;

jacee = jac(lds.coords,lds.coords);
rl = [];
    ...
    for c=lds.cols                    
        ...
        for d=lds.phases
            ...
            for d2=lds.phases
                ...
                stensv11(:,d2,d) = (wtk.*tens(:,kr2,d,d2))*v11_1;
            end    
            stenv1v11(:,d)=stenv1v11(:,d)+wtk.*stensv1(:,kr2,d)*v11_1;
            stenv11v11(:,d)=stenv11v11(:,d)+wtk.*stensv11(:,kr2,d)*v11_1;
        end
        fxhessv11h11(range2)=wtk.*shv11(:,kr2)*h11_1;        
        fxhessv11h02(range2)=wtk.*shv11(:,kr2)*h02_1;        
        fxhessv1h02(range2)=wtk.*shv1(:,kr2)*h02_1;        
        fxtensv1v11v11(range2)=wtk.*stenv1v11(:,kr2)*v11_1;
        fxtensv11v11v11(range2)=wtk.*stenv11v11(:,kr2)*v11_1;
        range2 = range2+lds.nphase;
        range5 = range5+lds.nphase;
    end      
    range1 = range1 + lds.ncol;
...
cc = 1/(2*T)*w1.'*(fxtensv1v11v11.'+2*fxhessv11h11.'+fxhessv1h02.'-2*alpha11*fxjac*conj(v1));
c = conj(cc);
d = 1/(6*T)*w1'*(fxtensv11v11v11.'+3*fxhessv11h02.');
